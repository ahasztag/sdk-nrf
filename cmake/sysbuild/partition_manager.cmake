...
function(partition_manager)
  ...
  if(NOT "${PM_DOMAIN}" STREQUAL "CPUNET" AND NOT static_configuration AND
    ...
    if(SB_CONFIG_BOOTLOADER_MCUBOOT_ONLY_IMAGES OR SB_CONFIG_SECURE_BOOT_ONLY_IMAGES)
      message(FATAL_ERROR "SB_CONFIG_BOOTLOADER_MCUBOOT_ONLY_IMAGES and SB_CONFIG_SECURE_BOOT_ONLY_IMAGES "
                          "are only supported with partition manager static configuration.")
    endif()
  endif()
